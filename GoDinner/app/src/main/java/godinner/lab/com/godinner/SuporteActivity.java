...
public class SuporteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageListAdapter = new MessageListAdapter(this, mMensagemList);
        ...
        btnEnviar.setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View v) {
                if (socket.connected() && !txtMessageChat.getText().toString().isEmpty()) {
                    try {
                        JSONStringer jsonMessage = new JSONStringer();
                        jsonMessage.object();
                        jsonMessage.key("message").value(txtMessageChat.getText().toString());
